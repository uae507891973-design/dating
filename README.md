...
- [`frontend/`](frontend/) — визуальный прототип интерфейса (HTML/CSS/JS, без сборки). Откройте `frontend/index.html`.
...
- Стадия 3.2 реализована: видеознакомство «вслепую» (блюр, согласие на раскрытие, trust-бонус).
...
- [Поэтапный план работ по итогам аудита](docs/product/remediation-plan.md)
